package com.example.music_app_artist.internals;

import android.content.Context;
import android.content.Intent;
import android.content.SharedPreferences;
import com.example.music_app_artist.activities.LoginActivity;
...
public class SharePrefManagerUser {
    ...
    public User getUser() {
        ...
        user.setNickname(sharedPreferences.getString(KEY_NICKNAME, null));
